...
pub struct SwishSource {
    ...
    pub experience_context: Option<SwishExperienceContext>,
}

#[serde_with::skip_serializing_none]
#[derive(Debug, Clone, Serialize, Deserialize, TypedBuilder)]
pub struct SwishExperienceContext {
    ...
    /// The URL where we identify whether intent_url field should be returned in the response.
    #[builder(default, setter(strip_option, into))]
    pub return_intent_url: Option<String>,
}
